...
java -mx1024m -cp /usr/share/java/weka.jar weka.classifiers.trees.J48 -l ./models/j48.markey.traffic.analysis.model -p 8 -T ../../preprocessing/classify/output/$1 > ./output/$1.j48.01.$NOW.out
